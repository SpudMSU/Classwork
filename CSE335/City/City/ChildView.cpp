...
BEGIN_MESSAGE_MAP(CChildView, CWnd)
	...
	ON_COMMAND(ID_VIEW_MOUSETRACKS32805, &CChildView::OnViewMousetracks32805)
	ON_UPDATE_COMMAND_UI(ID_VIEW_MOUSETRACKS32805, &CChildView::OnUpdateViewMousetracks32805)
END_MESSAGE_MAP()
/// \endcond
...
void CChildView::OnViewMousetracks32805()
{
	mShowHistory = !mShowHistory;
}


void CChildView::OnUpdateViewMousetracks32805(CCmdUI* pCmdUI)
{
