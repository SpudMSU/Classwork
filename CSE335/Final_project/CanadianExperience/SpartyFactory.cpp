...
std::shared_ptr<CActor> CSpartyFactory::Create()
{
	...
	auto frost = make_shared<CImageDrawable>(L"Frostmourne", L"images/frostmourne.png");
	frost->SetCenter(Point(50, 30));
	frost->SetPosition(Point(-80, 115));
	rarm->AddChild(frost);
