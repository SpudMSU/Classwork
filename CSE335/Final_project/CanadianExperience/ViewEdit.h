...
public:
	...
	///event handler for harvest
	afx_msg void OnEditHarvest();

	///event handler for empty basket
	afx_msg void OnEditEmptybasket();

	///event handler for set seed
	afx_msg void OnEditSeedtree();
};
